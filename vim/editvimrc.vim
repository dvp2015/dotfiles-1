...
imap <S-F8> :call SwitchColor(-1)
imap <F8> :call SwitchColor(1)
xmap  <Plug>SpeedDatingUp
nmap  <Plug>SpeedDatingUp
nmap  <Plug>EasyClipSwapPasteBackwards
nmap  <Plug>EasyClipSwapPasteForward
nnoremap  h
snoremap  a<BS>
nmap 	 <Plug>EasyClipSwapPasteForward
...
nnoremap  gv :vsplit $MYVIMRC
nnoremap  ev :vsplit .vimrc
map    <Plug>(easymotion-prefix)
vmap  y <Plug>(yank-highlight)
nmap  y <Plug>(yank-highlight)
...
nmap  - :call Solarized8Contrast(-v:count1)
nnoremap  B :exe "colors" (g:colors_name =~# "dark" ? substitute(g:colors_name, 'dark', 'light', '') : substitute(g:colors_name, 'light', 'dark', '') )
nnoremap  a :Ack! 
snoremap ! "_c!
snoremap " "_c"
snoremap # "_c#
...
snoremap M "_cM
snoremap N "_cN
nnoremap O :echoerr "Use <leader>O instead"
snoremap O "_cO
snoremap P "_cP
...
xmap <silent> aa <Plug>AngryOuterPrefix
...
xmap <silent> ia <Plug>AngryInnerPrefix
...
onoremap <silent> <Plug>(operator-sequence-select-block) :normal! `[o`]
onoremap <silent> <Plug>(operator-sequence-select-line) :normal! V`[o`]
onoremap <silent> <Plug>(operator-sequence-select-char) :normal! v`[o`]
...
onoremap <Plug>(operator-highlight) g@
snoremap <Del> a<BS>
...
map <S-F8> :call SwitchColor(-1)
map <F8> :call SwitchColor(1)
cnoremap  <Esc>
...
set ignorecase
set incsearch
set langmap=йq,цw,уe,кr,еt,нy,гu,шi,щo,зp,х[,ъ],фa,ыs,вd,аf,пg,��h,оj,лk,дl,ж\\;,э',яz,чx,сc,мv,иb,тn,ьm,ю.,ё',ЙQ,ЦW,УE,КR,ЕT,НY,ГU,ШI,ЩO,ЗP,Х{,Ъ},ФA,ЫS,ВD,АF,ПG,РH,ОJ,ЛK,ДL,Ж:,Э\",ЯZ,ЧX,СC,МV,ИB,ТN,ЬM,Б<,Ю>
set langnoremap
set nolangremap
set laststatus=2
...
set ruler
set runtimepath=~/.vim,/usr/share/vim/vimfiles,~/.vim/bundle/repos/github.com/Shougo/vimproc.vim,~/.vim/bundle/repos/github.com/Shougo/dein.vim,~/.vim/bundle/repos/github.com/tomasr/molokai,~/.vim/bundle/repos/github.com/Valloric/YouCompleteMe,~/.vim/bundle/.cache/.vimrc/.dein,/usr/share/vim/vim80,~/.vim/bundle/.cache/.vimrc/.dein/after,/usr/share/vim/vimfiles/after,~/.vim/after
set scrolloff=2
set secure
set shiftround
set shiftwidth=4
...
set smarttab
set softtabstop=4
set statusline=%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}%*%#warningmsg#%{SyntasticStatuslineFlag()}%{fugitive#statusline()}
set noswapfile
set tabstop=4
set termguicolors
set textwidth=79
...
set shortmess=aoO
badd +356 dotfiles/.vimrc
badd +595 dotfiles/vimrc-minpac
badd +46 dotfiles/zshrc
badd +215 /media/dvp/SANDISK/dvp/dotfiles-2/.vimrc
badd +5 t.cpp
argglobal
silent! argdel *
...
silent! normal! zE
let s:l = 453 - ((10 * winheight(0) + 15) / 30)
...
wincmd w
argglobal
edit /media/dvp/SANDISK/dvp/dotfiles-2/.vimrc
xnoremap <buffer> <silent> [" :exe "normal! gv"|call search('\%(^\s*".*\n\)\%(^\s*"\)\@!', "bW")
nnoremap <buffer> <silent> [" :call search('\%(^\s*".*\n\)\%(^\s*"\)\@!', "bW")
xnoremap <buffer> <silent> [] m':exe "normal! gv"|call search('^\s*endf*\%[unction]\>', "bW")
nnoremap <buffer> <silent> [] m':call search('^\s*endf*\%[unction]\>', "bW")
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 95 - ((15 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
95
