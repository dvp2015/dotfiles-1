# Generated by Powerlevel10k configuration wizard on 2020-11-29 at 23:50 MSK.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 39417.
# Wizard options: compatible, classic, unicode, dark, blurred heads, blurred tails,
# 2 lines, disconnected, full frame, sparse, concise, instant_prompt=verbose.
